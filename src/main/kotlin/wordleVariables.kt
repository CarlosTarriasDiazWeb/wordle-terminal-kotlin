...
//val letterToCount = mutableMapOf<Char, Int>() //Diccionari d'ocurrències de cada caràcter. (JA NO S'UTILITZA)
...
val sizeSpanishDictionary = 109
val sizeEnglishDictionary = 109
var totalWords = sizeSpanishDictionary + sizeEnglishDictionary //Recull el total de paraules totals que es podran endevinar al joc. Cada paraula només pot sortir una sola vegada.
//Variables de canvi d'idioma del joc
var language = "ES" //Idioma per defecte.